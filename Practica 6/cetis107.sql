...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-02-2025 a las 01:16:35
...
INSERT INTO `carga_academica` (`id`, `clase_id`, `alumnos_id`, `calificacion`) VALUES
(1, 1, 1, 10),
(2, 2, 1, 10),
(3, 3, 1, 10),
(4, 4, 1, 10),
...
--
ALTER TABLE `carga_academica`
  ADD CONSTRAINT `carga_academica_ibfk_1` FOREIGN KEY (`alumnos_id`) REFERENCES `alumnos` (`id`),
